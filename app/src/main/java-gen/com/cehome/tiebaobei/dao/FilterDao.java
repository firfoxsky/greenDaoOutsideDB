...
public class FilterDao extends AbstractDao<Filter, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property MultipleChoice = new Property(3, String.class, "multipleChoice", false, "MULTIPLE_CHOICE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FILTER\" (" + //
                ...
                "\"NAME\" TEXT," + // 2: name
                "\"MULTIPLE_CHOICE\" TEXT," + // 3: multipleChoice
    ...
    protected void bindValues(SQLiteStatement stmt, Filter entity) {
        ...
        String multipleChoice = entity.getMultipleChoice();
        if (multipleChoice != null) {
            stmt.bindString(4, multipleChoice);
        }
    ...
    public Filter readEntity(Cursor cursor, int offset) {
        Filter entity = new Filter( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // multipleChoice
    ...
    public void readEntity(Cursor cursor, Filter entity, int offset) {
        ...
        entity.setMultipleChoice(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
