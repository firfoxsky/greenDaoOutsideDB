...
public class CityDao extends AbstractDao<City, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property NameSort = new Property(2, String.class, "nameSort", false, "NAME_SORT");
    };
    ...
    public City readEntity(Cursor cursor, int offset) {
        City entity = new City( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // nameSort
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, City entity, int offset) {
        ...
        entity.setNameSort(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
